package http.network_trojan_killing;
...
public class network_trojan_process extends testBase12 {
    OkHttpClient client;
    MediaType mediaType;
    Request request1;
    String asjson;
    ...
    //对应终端执行网马查杀（自定义路径，较快出结果）第一次应该没有病毒记录
    //获取列表状态，查看本次病毒查杀是否完成
...
//      node_id = "0c87bfc92e342172430acfa8763b266cf7f2605cc53b8bf6ee17e191ded4e9ed";
    ...
    public void fix_intelligent_items() throws IOException {
        ...
        // RequestBody body = RequestBody.create(mediaType, "{\"list\":[{\"desc\":\"Rogue/ConPack.c\",\"path\":\"/usr/mxj1/lightnews.exe\",\"hash\":\"8c797094b1c8e8f5d657db7089b15916\"}],\"node_id\":\"0c87bfc92e342172430acfa8763b266cf7f2605cc53b8bf6ee17e191ded4e9ed\"}");
        RequestBody body = RequestBody.create(mediaType,"{\"list\":[{\"desc\":\"Rogue/ConPack.c\",\"path\":\""+cur_path+"\"}],\"node_id\":\""+node_id+"\"}");
